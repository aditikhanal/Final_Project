...
The study compares several ML algorithms — **Random Forest**, **XGBoost**, **Logistic Regression**, and **K-Nearest Neighbors (KNN)** and also conducts time series based approach using **LSTM model**
